// ccwg-api-client.go — CommonCrawl WebGraph API client (Go, stdlib only)
//
// RUN:
//   go run ccwg-api-client.go
//
// Or compile and run separately:
//   go build -o ccwg-api-client ccwg-api-client.go
//   ./ccwg-api-client
//
// REQUIRES:
...
// --- API endpoint ---
var apiURL = "https://ccwg-api.customdatasets.com/"

func main() {
	client := &http.Client{Timeout: 30 * time.Second}

	resp, err := client.Post(apiURL, "text/plain", bytes.NewBufferString(hostnames))
	if err != nil {
